...
variable "external_subnet_ids" {
  ...
  type = list(object({
    ...
    private_ip_tertiary  = string
  }))
  default = [{ "subnet_id" = null, "public_ip" = null, "private_ip_primary" = null, "private_ip_secondary" = null, "private_ip_tertiary" = null }]
}
...
variable "tertiary_vip_disable" {
  type        = bool
  description = "Disable the tertiary public VIP association on the external interface"
  default     = false
}
variable "sleep_time" {
  type        = string
